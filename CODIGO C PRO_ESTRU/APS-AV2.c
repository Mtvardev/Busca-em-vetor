...
void Cadastro()
{
    AlocarMemoria();
          for(int i=0;i<total;i++)
          {
                ...
                printf("Aluno: "); scanf("%s",&aluno[i].nome);
                printf("Matricula: "); scanf("%s",&aluno[i].cod);
                printf("Media: "); scanf("%f",&aluno[i].media);
          }
                system("cls");
                Arquivo();
                printf("\n---------------");
     ...
     arqaluno=fopen("DadosAluno.txt","a");
               if(arqaluno==NULL)
                ...
                for(int i=0;i<total;i++)
                 {
                  fprintf(arqaluno,"--------------------------------------------- \n");
                  fprintf(arqaluno,"Nome: %s| Matricula: %s | Media: %.2f \n",aluno[i].nome,aluno[i].cod,aluno[i].media);
                 }
                  fprintf(arqaluno,"--------------------------------------------- \n");
    fclose(arqaluno);    
...
void AlocarMemoria()
{
                printf("Quantindade de alunos:"); scanf("%d",&total);
                system("cls");
                //alocando memoria com malloc para minha estrura (vetor de registro) com a quantidade que usuario solicitar. 
